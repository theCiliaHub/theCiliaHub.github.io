...
            } else {
                // Direct organelle matching for others
                matchedProfileKey = Object.keys(organelleMarkerProfiles).find(key => 
                    key !== 'Cilia' && (loc.toLowerCase().includes(key.toLowerCase()) || key.toLowerCase().includes(loc.toLowerCase()))
                );
            }
            
...
        borderWidth: 3,
        pointRadius: 4,
        hidden: true // User gene set also hidden by default per request
    });
    
