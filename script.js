...
// Safe wrapper for generating plots
async function generateEnrichmentPlotsSafe() {
    // Ensure the database is loaded
    await loadAndPrepareDatabase();

    // Call the main plotting function
    generateEnrichmentPlots();
}

// In displayEnrichmentPage(), replace the click listener:
document.getElementById('generate-plot-btn')
        .addEventListener('click', generateEnrichmentPlotsSafe);
