/* ==============================================================
 * CiliAI – Interactive Explorer (v4.2 – Nov 15, 2025)
 * ==============================================================
 * • FINAL: This is the complete, unified file.
 * • FIXES: Layout, data parsing (ciliopathy/localization),
 * and all query normalization/routing logic.
 * ============================================================== */
...
(function () {
    ...
    async function initCiliAI() {
        console.log('CiliAI: Initializing (v4.2 Final)...');
    ...
    async function loadCiliAIData(timeoutMs = 30000) {
        ...
        function extractCiliopathyInfo(gene) {
            // This function is now OBSOLETE because buildLookups handles it.
        ...
        const masterData = hubData.map(gene => {
            ...
            return {
                ...
                ...explicit,
                ...orthologs,
                ciliopathy, // Pass raw ciliopathy
                ciliopathy_classification, // Pass raw classification
                screens: allScreens,
                expression: {
    ...
    // ==========================================================
    // 4. CILIBRAIN v4.2 - QUERY & PLOTTING ENGINE
    // ==========================================================
    ...
    function handleGeneSearch(geneSymbol, queryAI = true) {
        ...
        if (geneData.localization) {
            const locString = ensureArray(geneData.localization).join(', ').toLowerCase();
    ...
    function handlePhylogenyVisualizationQuery(genes, source = 'li', type = 'heatmap') {
        ...
        try {
            ...
            plotDiv.prepend(backButton); // Add button to the plot div
