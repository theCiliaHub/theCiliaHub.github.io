...
function parseComplexQuery(rawQuery, allGenes = []) {
    ...
    // Default: genes exist but no specific intent
    if (entities.genes.length > 0) {
        return { intent: 'GET_FUNCTION', entities };
    }
