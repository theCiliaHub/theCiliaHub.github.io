// ciliAI.js - Fully integrated with Phylogenetics, D3 Heatmap, and all original functions restored.
                ...
                <div class="ciliai-main-content">
                    <div class="ai-query-section">
                        ...
                        <div class="ai-input-group autocomplete-wrapper">
                            <input type="text" id="aiQueryInput" class="ai-query-input" placeholder="e.g., distribution of IFT88">
                    ...
                    <div class="input-section">
                        ...
                        <div class="input-group">
                            ...
                            <div class="autocomplete-wrapper">
                                <textarea id="geneInput" class="gene-input-textarea" placeholder="Start typing a gene symbol..."></textarea>
                        ...
                        <div class="input-group">
                            ...
                            <div class="mode-selector">
                                <div class="mode-option">
                                    ...
                                    <label for="hybrid" title="Best for most users. Combines expert database, screen data, and AI literature mining.">
                                ...
                                <div class="mode-option">
                                    <input type="radio" id="expert" name="mode" value="expert">
                                     <label for="expert" title="Fastest option. Queries only our internal database and screen data.">
                                ...
                                <div class="mode-option">
                                    ...
                                    <label for="nlp" title="Most current data. Performs live AI-powered search across PubMed.">
                                        <span class="mode-icon">📚</span>
